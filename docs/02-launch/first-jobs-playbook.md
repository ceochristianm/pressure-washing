...
1. **Active-listing cold calls:** Zillow/Redfin → filter Palm Beach County listings
   30+ days on market → look for visible mold/dirt in listing photos → call the
   listing agent (number is on the listing). Reference the specific property and
   what's visible in their photos. Offer fast turnaround before their next open house.
2. **Office walk-ins:** 2–3 high-volume brokerages, professional polo, ask the front
   desk for whoever manages the preferred-vendor list.
...
- [ ] BEFORE photos + video of the worst areas (wide + close-up)
- [ ] AFTER from identical angles
- [ ] 10–20 sec phone clips of surface cleaner in action (ad creative gold)
- [ ] Google review requested on-site while the wow is fresh (text them the direct link)
